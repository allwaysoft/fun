...
--FNAME             VARCHAR2(10) :='VEN_PAY';
--SENDER            VARCHAR2(50) :='ORACLE.DBA@CADDELL.COM';
RECEPIENT         DA.BPVENDORS.BPVEN_PAY_EMAIL%TYPE :='KRANTHI.PABBA@HOTMAIL.COM';
V_ERR_MSG         MAX_STRING%TYPE := '';
V_HEADER_TEXT     MAX_STRING%TYPE;
TEXT              MAX_STRING%TYPE;
...
--P_SENDER VARCHAR2(50) := 'kranthi.pabba@caddell.com';
--RECEPIENT VARCHAR2(255) := 'kranthi.pabba@gmail.com';
--text varchar2(32000);
...
DBMS_OUTPUT.PUT_LINE(5);    
      ...
      --END IF;
        ...
        UTL_SMTP.WRITE_DATA(V_CONN, 'SUBJECT: ' || 'TEST' || UTL_TCP.CRLF);
