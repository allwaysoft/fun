...
V_HEADER_L8       HEADER_STRING%TYPE := 'Invoice Invoice                                     Invoice    Discount     Payment';
V_HEADER_L9       HEADER_STRING%TYPE := 'Date    Number     Invoice Description               Amount      Amount      Amount';
V_HEADER_L10      HEADER_STRING%TYPE := '------- ---------- ---------------------------- ----------- ----------- -----------';
--'REA001','READ001','REAM001'
...
V_HEADER_TEXT := RPAD(LPAD(V_HEADER_L1, (83-LENGTH(V_HEADER_L1))/2+LENGTH(V_HEADER_L1), ' '), 83, ' ')
     ...
     || CHR(13) || CHR(10)
     || RPAD(LPAD(V_HEADER_L4, (83-LENGTH(V_HEADER_L4))/2+LENGTH(V_HEADER_L4), ' '), 83, ' ')
     || CHR(13) || CHR(10)
     || RPAD(LPAD(V_HEADER_L5, (83-LENGTH(V_HEADER_L5))/2+LENGTH(V_HEADER_L5), ' '), 83, ' ')
     || CHR(13) || CHR(10)
     || RPAD(LPAD(V_HEADER_L6, (83-LENGTH(V_HEADER_L6))/2+LENGTH(V_HEADER_L6), ' '), 83, ' ')
     || CHR(13) || CHR(10)
     || RPAD(LPAD(V_HEADER_L7, (83-LENGTH(V_HEADER_L7))/2+LENGTH(V_HEADER_L7), ' '), 83, ' ')
     || CHR(13) || CHR(10)
     || RPAD(LPAD(V_HEADER_L8, (83-LENGTH(V_HEADER_L8))/2+LENGTH(V_HEADER_L8), ' '), 83, ' ')
     || CHR(13) || CHR(10)
     || RPAD(LPAD(V_HEADER_L9, (83-LENGTH(V_HEADER_L9))/2+LENGTH(V_HEADER_L9), ' '), 83, ' ')
     || CHR(13) || CHR(10)     
     || RPAD(V_HEADER_L10, 83, '-')
     || CHR(13) || CHR(10);
