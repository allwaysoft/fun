--------------------------------------------------------------------------------
--I frequently get a question about how to find out when was a table last modified. I’m talking 
--about table data, not table structure, the latter would be detectable from dba_objects.last_ddl_time.
--
