...
CREATE OR REPLACE VIEW DA1.EMPLOYEE_PAY_CADVW (EPC_ROW_ORDER, EPC_START_DATE, EPC_END_DATE
                                             ...
                                             , EPC_EMP_NO2, EPC_PERIOD, EPC_FNAME_TSH_DATE
                                             , EPC_SHIFT_CODE, EPC_LNAME_TSH_NH_RATE_CODE
...
SELECT ROW_ORDER, PPR_START_DATE, PPR_END_DATE, TSH_EMP_NO1, TSH_COMP_CODE, EMP_LAST_NAME
     , TSH_PRN_CODE, TSH_PROCESS_FLAG, TSH_APRV_STATUS, TSH_EMP_NO2, PPR_PERIOD, EMP_FNAME_TSH_DATE
     , TSH_SHIFT_CODE, EMP_LNAME_TSH_NH_RATE_CODE, EMP_MNAME_TSH_COMP_CODE
...
SELECT 2
     , NULL
     , DECODE(EPC_LNAME_TSH_NH_RATE_CODE, 'REG', '21', 'OT', '22', 'OTS', '23', '29'
                                        , NVL(EPC_LNAME_TSH_NH_RATE_CODE, '777777777'))
     , EPC_START_DATE
     , EPC_END_DATE
     , EPC_EMP_NO1
     , EPC_COMP_CODE
     , 'TOTAL '|| EPC_LNAME_TSH_NH_RATE_CODE || '  HOURS: ' 
     , EPC_NORMAL_HOURS
     , EPC_NH_PAY_AMT
...
SELECT 3
     ...
     , DECODE(EPC_LNAME_TSH_NH_RATE_CODE, 'REG', '31', 'OT', '32', 'OTS', '33'
                                        , NVL(EPC_LNAME_TSH_NH_RATE_CODE, '88888888'))
     , EPC_START_DATE                 
     , EPC_END_DATE                   
     , EPC_EMP_NO1                    
     , EPC_COMP_CODE                  
