/*select * from temp_garage_aug2010*/


alter session set timing on

--create table temp_garage_aug2010 as
...
AND    sd.PartitioningDate    <  to_date('2007-11-01-00-00-00','YYYY-MM-DD-HH24-MI-SS')
AND  hol.service_date(+) >= to_date('2007-09-01-03-00-00','YYYY-MM-DD-HH24-MI-SS')     --This and below line are very important otherwise it is taking 10 hrs for 1 month.
AND  hol.service_date(+) <= to_date('2007-10-01-02-59-59','YYYY-MM-DD-HH24-MI-SS')
    AND    1=1
GROUP    BY
