...
Rem    kpabba      03/18/12 - included upper case charecter check and few other changes...
Rem
Rem
...
select 'c:\oracle\scripts\logs_' vpath, SYS_CONTEXT ('USERENV', 'DB_NAME') loc, '/user_pass_verify_func.log' ext from dual;  
...
CREATE OR REPLACE FUNCTION mbta_user_verify_function
(username varchar2,
  password varchar2,
