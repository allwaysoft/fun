  ...
  CREATE OR REPLACE PROCEDURE "MBTA"."SP_PSSR_2009_CANCELAMOUNT" 
		(nQueryID 		  NUMBER
		,dDateFirst 	  DATE
		,dDateLast 		  DATE
		,pRoute 		    VARCHAR2
...
IS
--------------------------------------------------------------------------------
-- Procedure: SP_PSSR_2004
-- Product sales summary report
--
-- Creation :	2008-04-23		A. Bujnoch
--
-- Purpose  :	Executes query for product sales summary reports
--
--
...
--------------------------------------------------------------------------------
--
-- Changes	:	2009-01-16	ABU		Seperated Cancel Amount from CreditAmount
--									negative amount to Total amount
--
-- Changes  : 2010-04-29 AS     Cancel Amount Deducted from the Cash Sales.
-- Changes  : 2010-05-21 AS     Cancel Amount Deducted from the Cash Sales.
--------------------------------------------------------------------------------
...
'INSERT INTO
	...
	,Data6		--	SumAmountWoToken

	,Data7		--	SumCreditAmount
	,Data11		--	SumCancelAmount
	,Data8		--	SumCheckAmount

	,Data9		--	SumCashAmountWoToken

	,Data10		--	SumTokenAmount
	)
';
--------------------------------------------------------------------------------
	stmt_Select					VARCHAR2	(20000) :=							-- Select statement
'SELECT
		/*+
%HintMain%
		*/
...
'
		...
		stmt_HintClp	:=
'							INDEX		(clp	XIE4CashlessPayment)
'
		;

		stmt_HintCp	:=
'							INDEX		(cp		XIE1CashPayment)
'
		;

		stmt_HintSd	:=
'							INDEX		(sd		XIE5SalesDetail)
'
		;

		stmt_HintSt	:=
'							INDEX		(st		XIE2SalesTransaction)
'
		;
