		...
		FROM
			...
			--------------------------------------------------------------------
				...
				--
					...
					AND	st.CreaDate					>=	To_Date	('2009-09-01 03-00-00','YYYY-MM-DD HH24-MI-SS')
					AND	st.CreaDate					<=	To_Date	('2009-10-01 02-59-59','YYYY-MM-DD HH24-MI-SS')
					AND	st.PartitioningDate			>=	To_Date	('2009-09-01 03-00-00','YYYY-MM-DD HH24-MI-SS')
			...
			--------------------------------------------------------------------
				...
				--
					...
					AND	cp.CreaDate					>=	To_Date	('2009-09-01 03-00-00','YYYY-MM-DD HH24-MI-SS')
					AND	cp.CreaDate					<=	To_Date	('2009-10-01 02-59-59','YYYY-MM-DD HH24-MI-SS')
					AND	cp.PartitioningDate			>=	To_Date	('2009-09-01 03-00-00','YYYY-MM-DD HH24-MI-SS')
			...
			--------------------------------------------------------------------
				...
				--	Parameter conditions
				--
					AND	sd.CreaDate					>=	To_Date	('2009-09-01 03-00-00','YYYY-MM-DD HH24-MI-SS')
					AND	sd.CreaDate					<=	To_Date	('2009-10-01 02-59-59','YYYY-MM-DD HH24-MI-SS')
					AND	sd.PartitioningDate			>=	To_Date	('2009-09-01 03-00-00','YYYY-MM-DD HH24-MI-SS')
				GROUP	BY
	 		 		 sd.DeviceClassId
					,sd.DeviceId
					,sd.UniqueMsId
			...
			--------------------------------------------------------------------
				...
				--
					...
					AND	clp.CreaDate				>=	To_Date	('2009-09-01 03-00-00','YYYY-MM-DD HH24-MI-SS')
					AND	clp.CreaDate				<=	To_Date	('2009-10-01 02-59-59','YYYY-MM-DD HH24-MI-SS')
					AND	clp.PartitioningDate		>=	To_Date	('2009-09-01 03-00-00','YYYY-MM-DD HH24-MI-SS')
