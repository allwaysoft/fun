VERSION 5.00
Begin VB.Form Frm_Meantime 
   Caption         =   "Mean time reporting"
   ClientHeight    =   9345
   ClientLeft      =   3150
   ClientTop       =   2085
   ClientWidth     =   11715
   ...
   Begin VB.Frame Fra_Totals 
      ...
      Begin VB.ComboBox Cbo_Group1 
         Height          =   315
         ItemData        =   "Frm_Meantime.frx":0000
         Left            =   6120
         List            =   "Frm_Meantime.frx":002E
         TabIndex        =   54
         Text            =   " "
         Top             =   480
         Width           =   2295
      ...
      Begin VB.ComboBox Cbo_Group2 
         Height          =   315
         ItemData        =   "Frm_Meantime.frx":00CA
         Left            =   6120
         List            =   "Frm_Meantime.frx":00F8
         TabIndex        =   53
         Text            =   " "
         Top             =   840
         Width           =   2295
      ...
      Begin VB.ComboBox Cbo_Group3 
         Height          =   315
         ItemData        =   "Frm_Meantime.frx":0193
         Left            =   6120
         List            =   "Frm_Meantime.frx":01C1
         TabIndex        =   52
         Text            =   " "
         Top             =   1200
         Width           =   2295
      ...
      Begin VB.ComboBox Cbo_Group4 
         Height          =   315
         ItemData        =   "Frm_Meantime.frx":025D
         Left            =   6120
         List            =   "Frm_Meantime.frx":028B
         TabIndex        =   51
         Text            =   " "
         Top             =   1560
         Width           =   2295
      ...
      Begin VB.ComboBox Cbo_Sort1 
         Height          =   315
         ItemData        =   "Frm_Meantime.frx":0327
         Left            =   8760
         List            =   "Frm_Meantime.frx":0334
         TabIndex        =   50
         Text            =   " "
         Top             =   480
         Width           =   1935
      ...
      Begin VB.ComboBox Cbo_Sort2 
         Height          =   315
         ItemData        =   "Frm_Meantime.frx":0352
         Left            =   8760
         List            =   "Frm_Meantime.frx":035F
         TabIndex        =   49
         Text            =   " "
         Top             =   840
         Width           =   1935
      ...
      Begin VB.ComboBox Cbo_Sort3 
         Height          =   315
         ItemData        =   "Frm_Meantime.frx":037D
         Left            =   8760
         List            =   "Frm_Meantime.frx":038A
         TabIndex        =   48
         Text            =   " "
         Top             =   1200
         Width           =   1935
      ...
      Begin VB.ComboBox Cbo_Sort4 
         Height          =   315
         ItemData        =   "Frm_Meantime.frx":03A8
         Left            =   8760
         List            =   "Frm_Meantime.frx":03B5
         TabIndex        =   47
         Text            =   " "
         Top             =   1560
         Width           =   1935
   ...
   Begin VB.Frame Fra_Sorting 
      ...
      Begin VB.ComboBox Cbo_Group 
         Height          =   315
         ItemData        =   "Frm_Meantime.frx":03D9
         Left            =   6600
         List            =   "Frm_Meantime.frx":03F8
         TabIndex        =   40
         Top             =   360
         Width           =   3495
      End
      Begin VB.ListBox Lst_Sort 
         Height          =   645
         ItemData        =   "Frm_Meantime.frx":0474
         Left            =   1200
         List            =   "Frm_Meantime.frx":0490
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.ComboBox Cbo_MaintSec 
         Height          =   315
         ItemData        =   "Frm_Meantime.frx":04F8
         Left            =   8400
         List            =   "Frm_Meantime.frx":052E
         TabIndex        =   33
         Top             =   600
         Width           =   2175
      End
      Begin VB.ListBox Lst_Stations 
         Height          =   840
         ItemData        =   "Frm_Meantime.frx":05D4
         Left            =   4560
         List            =   "Frm_Meantime.frx":05D6
         MultiSelect     =   2  'Extended
         TabIndex        =   23
         Top             =   360
         Width           =   2415
      ...
      Begin VB.ListBox Lst_Lines 
         Height          =   840
         ItemData        =   "Frm_Meantime.frx":05D8
         Left            =   1320
         List            =   "Frm_Meantime.frx":05DA
         MultiSelect     =   2  'Extended
         TabIndex        =   21
         Top             =   360
         Width           =   1815
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ListBox Lst_Item_Types 
         Height          =   840
         ItemData        =   "Frm_Meantime.frx":05DC
         Left            =   3840
         List            =   "Frm_Meantime.frx":05DE
         MultiSelect     =   2  'Extended
         TabIndex        =   19
         Top             =   360
         Width           =   2415
   ...
   End
End
Attribute VB_Name = "Frm_Meantime"
