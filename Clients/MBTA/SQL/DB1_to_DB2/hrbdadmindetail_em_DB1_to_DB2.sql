...
where bd_code not like 'ZZ%';
dbms_output.put_line ('Inserted '||v_cnt||' records into HRBDADMINDETAIL_EM table.');
...
then
dbms_output.put_line ('Number of records in &to_which_database match with &from_which_database for HRBDADMINDETAIL_EM table, check and commit.');
else
