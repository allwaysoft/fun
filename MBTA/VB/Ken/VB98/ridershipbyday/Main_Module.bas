...
Public Sub Load_Farebox()
    ...
    "USE_NL(tvm) USE_NL (sta) */ to_char(sd.creadate,'mm/dd/yyyy') transdate, tt.description Product, " & _
    "To_Char(Nvl(sd.BranchLineId, 0)) BranchLineid, tst.description tickettype, "
    ...
    "AND mcm.DeviceClassID = (SELECT DeviceClassID from deviceclass where deviceclasstype = 5) " & _
    "Group By to_char(sd.creadate,'mm/dd/yyyy'),tt.description,sd.BranchLineId,tst.description"
...
Do While RSData.EOF = False
        sSql = "insert into Ridership_Farebox_day (year, month, Day, signcode, Product, stocktype, rider3am, " & _
        ...
        "(" & Mid(RSData("transdate"), 8, 4) & "," & Mid(RSData("transdate"), 1, 2) & "," & Mid(RSData("transdate"), 4, 2) & "," & RSData("Branchlineid") & ",'" & _
        RSData("Product") & "','" & RSData("tickettype") & "'," & RSData("Rider3am") & "," & RSData("Rider4am") & "," & _
...
Public Sub Load_Gates()
    ...
    "Group By to_char(sd.creadate,'mm/dd/yyyy'),tt.description,sta.name,tst.description, rt.description "
...
Debug.Print sSql
    ...
    Debug.Print sSql
    Do While RSData.EOF = False
        sSql = "insert into ridership_gates_day (year, month, day, Location, route, Product, stocktype, rider3am, " & _
        "rider4am, rider5am, rider6am, rider7am, rider8am, rider9am, rider10am, rider11am, rider12pm, " & _
        "rider1pm, rider2pm, rider3pm, rider4pm, rider5pm, rider6pm, rider7pm, rider8pm, rider9pm, " & _
        "rider10pm, rider11pm, rider12am, rider1am, rider2am) Values" & _
        "(" & Mid(RSData("transdate"), 7, 4) & "," & Mid(RSData("transdate"), 1, 2) & "," & Mid(RSData("transdate"), 4, 2) & ",'" & RSData("location") & "','" & _
        Replace(RSData("route"), "'", "''") & "','" & RSData("Product") & "','" & RSData("tickettype") & "'," & RSData("Rider3am") & "," & RSData("Rider4am") & "," & _
        RSData("Rider5am") & "," & RSData("Rider6am") & "," & RSData("Rider7am") & "," & RSData("Rider8am") & "," & _
        RSData("Rider9am") & "," & RSData("Rider10am") & "," & RSData("Rider11am") & "," & RSData("Rider12pm") & "," & _
        RSData("Rider1pm") & "," & RSData("Rider2pm") & "," & RSData("Rider3pm") & "," & RSData("Rider4pm") & "," & _
        RSData("Rider5pm") & "," & RSData("Rider6pm") & "," & RSData("Rider7pm") & "," & RSData("Rider8pm") & "," & _
...
Public Sub Load_Validators()
    ...
    Do While RSData.EOF = False
        sSql = "insert into ridership_Validator_day (year, month, Day, Location, route, Product, stocktype, rider3am, " & _
        "rider4am, rider5am, rider6am, rider7am, rider8am, rider9am, rider10am, rider11am, rider12pm, " & _
        "rider1pm, rider2pm, rider3pm, rider4pm, rider5pm, rider6pm, rider7pm, rider8pm, rider9pm, " & _
        "rider10pm, rider11pm, rider12am, rider1am, rider2am) Values" & _
        "(" & Mid(RSData("transdate"), 7, 4) & "," & Mid(RSData("transdate"), 1, 2) & "," & Mid(RSData("transdate"), 4, 2) & ",'" & Replace(RSData("location"), "'", "''") & "','" & _
        Replace(RSData("route"), "'", "''") & "','" & RSData("Product") & "','" & RSData("tickettype") & "'," & RSData("Rider3am") & "," & RSData("Rider4am") & "," & _
        RSData("Rider5am") & "," & RSData("Rider6am") & "," & RSData("Rider7am") & "," & RSData("Rider8am") & "," & _
        RSData("Rider9am") & "," & RSData("Rider10am") & "," & RSData("Rider11am") & "," & RSData("Rider12pm") & "," & _
        RSData("Rider1pm") & "," & RSData("Rider2pm") & "," & RSData("Rider3pm") & "," & RSData("Rider4pm") & "," & _
