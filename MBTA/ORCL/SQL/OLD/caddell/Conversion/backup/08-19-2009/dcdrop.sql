...
PROMPT ======================================================================
PROMPT Drop table DA.DC_HRDISCIPLINE
PROMPT ======================================================================
drop table DA.DC_HRDISCIPLINE;

PROMPT ======================================================================
PROMPT Drop table DA.DC_PMROLE
PROMPT ======================================================================
drop table DA.DC_PMROLE;

PROMPT ======================================================================
PROMPT Drop table DA.DC_PMPROJCONTACTROLE
PROMPT ======================================================================
drop table DA.DC_PMPROJCONTACTROLE;

PROMPT ======================================================================
PROMPT Drop table DA.DC_PRMACCUMULTRS
PROMPT ======================================================================
drop table DA.DC_PRMACCUMULTRS;

PROMPT ======================================================================
PROMPT Drop table DA.DC_PRMLASTEQPSVC
PROMPT ======================================================================
drop table DA.DC_PRMLASTEQPSVC;

PROMPT ======================================================================
PROMPT Drop table DA.DC_PYBENTRD_HEADER
PROMPT ======================================================================
drop table DA.DC_PYBENTRD_HEADER;

PROMPT ======================================================================
PROMPT Drop table DA.DC_PYBENTRD_DETAIL
PROMPT ======================================================================
drop table DA.DC_PYBENTRD_DETAIL;

PROMPT ======================================================================
PROMPT Drop table DA.DC_PYCOMMAX
PROMPT ======================================================================
drop table DA.DC_PYCOMMAX;

PROMPT ======================================================================
PROMPT Drop table DA.DC_PY_GENERIC_CREW_HEADER
PROMPT ======================================================================
drop table DA.DC_PY_GENERIC_CREW_HEADER;

PROMPT ======================================================================
PROMPT Drop table DA.DC_PY_GENERIC_CREW_DETAIL
PROMPT ======================================================================
drop table DA.DC_PY_GENERIC_CREW_DETAIL;

PROMPT ======================================================================
PROMPT Drop table DA.DC_PY_CREW_HEADER
PROMPT ======================================================================
drop table DA.DC_PY_CREW_HEADER;

PROMPT ======================================================================
PROMPT Drop table DA.DC_PY_CREW_DETAILS
PROMPT ======================================================================
drop table DA.DC_PY_CREW_DETAILS;

PROMPT ======================================================================
PROMPT Drop table DA.DC_PRMWORKITEMS_POSTED
PROMPT ======================================================================
drop table DA.DC_PRMWORKITEMS_POSTED;

PROMPT ======================================================================
PROMPT Drop table DA.DC_BABANKACCT
PROMPT ======================================================================
drop table DA.DC_BABANKACCT;

PROMPT ======================================================================
PROMPT Drop table DA.DC_PYCHKLOC
PROMPT ======================================================================
drop table DA.DC_PYCHKLOC;
...
PROMPT ======================================================================
PROMPT Drop package DA.DBK_DC_HRDISCIPLINE
PROMPT ======================================================================
drop package DA.DBK_DC_HRDISCIPLINE;

PROMPT ======================================================================
PROMPT Drop package DA.DBK_DC_PMROLE
PROMPT ======================================================================
drop package DA.DBK_DC_PMROLE;

PROMPT ======================================================================
PROMPT Drop package DA.DBK_DC_PMPROJCONTACTROLE
PROMPT ======================================================================
drop package DA.DBK_DC_PMPROJCONTACTROLE;

PROMPT ======================================================================
PROMPT Drop package DA.DBK_DC_PRMACCUMULTRS
PROMPT ======================================================================
drop package DA.DBK_DC_PRMACCUMULTRS;

PROMPT ======================================================================
PROMPT Drop package DA.DBK_DC_PRMLASTEQPSVC
PROMPT ======================================================================
drop package DA.DBK_DC_PRMLASTEQPSVC;

PROMPT ======================================================================
PROMPT Drop package DA.DBK_DC_PYBENTRD_HEADER
PROMPT ======================================================================
drop package DA.DBK_DC_PYBENTRD_HEADER;

PROMPT ======================================================================
PROMPT Drop package DA.DBK_DC_PYBENTRD_DETAIL
PROMPT ======================================================================
drop package DA.DBK_DC_PYBENTRD_DETAIL;

PROMPT ======================================================================
PROMPT Drop package DA.DBK_DC_PYCOMMAX
PROMPT ======================================================================
drop package DA.DBK_DC_PYCOMMAX;

PROMPT ======================================================================
PROMPT Drop package DA.DBK_DC_PY_GENERIC_CREW_HEADER
PROMPT ======================================================================
drop package DA.DBK_DC_PY_GENERIC_CREW_HEADER;

PROMPT ======================================================================
PROMPT Drop package DA.DBK_DC_PY_GENERIC_CREW_DETAIL
PROMPT ======================================================================
drop package DA.DBK_DC_PY_GENERIC_CREW_DETAIL;

PROMPT ======================================================================
PROMPT Drop package DA.DBK_DC_PY_CREW_HEADER
PROMPT ======================================================================
drop package DA.DBK_DC_PY_CREW_HEADER;

PROMPT ======================================================================
PROMPT Drop package DA.DBK_DC_PY_CREW_DETAILS
PROMPT ======================================================================
drop package DA.DBK_DC_PY_CREW_DETAILS;

PROMPT ======================================================================
PROMPT Drop package DA.DBK_DC_PRMWORKITEMS_POSTED
PROMPT ======================================================================
drop package DA.DBK_DC_PRMWORKITEMS_POSTED;

PROMPT ======================================================================
PROMPT Drop package DA.DBK_DC_BABANKACCT
PROMPT ======================================================================
drop package DA.DBK_DC_BABANKACCT;

PROMPT ======================================================================
PROMPT Drop package DA.DBK_DC_PYCHKLOC
PROMPT ======================================================================
drop package DA.DBK_DC_PYCHKLOC;
