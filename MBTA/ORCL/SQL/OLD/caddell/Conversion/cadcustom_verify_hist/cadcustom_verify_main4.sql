...
PROMPT /=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=
PROMPT
PROMPT  CAN CHECK DA1.ERRORS TABLE FOR TABLE BY TABLE INSERT STATUS WHILE PROCESS IN PROGRESS.
...
v_tabs_rem := 'PYEMPSECGRPUSER, BPARTNERS, BPADDRESSES, BABANK, BABRANCH, BABANKACCT, BPBANKS, '
            ||'PYCOMPAYGRP, PYTRADES, PYWCBCODE, PYWCBRATE, JCMPHS, BPVENDORS, CHEQUE, BPCUSTOMERS, JCJOB_TABLE, '
            ...
            ||'PYEMPSALSPL, PYCHKLOC, PYTAXEXM, PYJOBPAYRATE, PYJOBALLOC, '
            ||'PYEMPPAYHIST_COMMENTED, PMPROJECT_TABLE, SCMAST, SCSCHED, VOUCHER, VOUCHQ, PYEMPTIMSHT, VOUDIST, '
            ||'VOURLSDET, GLEDGER, JCDETAIL.';
...
--			values(v_cnt_err,v_tab_name,'COMPLETE');
--	commit;
  --      v_msg1 := ' --JCJOBSECGRPUSER table is populated based on PYEMPSECGRP table.'||chr(10);
--	end;
...
Loop
   ...
   << L_endloop >>
      null;
End loop;   
v_msg1 := v_msg1||' --PYMultiGeoEmpListing table is populated for inconsistent Employees.'||chr(10);
End;
