...
v_tabs_rem := 'PYEMPSECGRPUSER, BPARTNERS, BPADDRESSES, BABANK, BABRANCH, BABANKACCT, BPBANKS, '
            ...
            ||'PYEMPSALSPL, PYCHKLOC, PYTAXEXM, PYJOBPAYRATE, BPVENDORS, CHEQUE, BPCUSTOMERS, JCMPHS, JCJOB_TABLE, '
            ||'JCJOBSECGRPJOB, JCJOBHPHS, JCJOBCAT, JCUTRAN, JBCONT, JBITEMNAMES, JBCONTDET, PYJOBALLOC, '
