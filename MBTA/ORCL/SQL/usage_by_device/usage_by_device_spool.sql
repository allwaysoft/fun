...
|| '","' ||  mcm.movementtype
|| '","' ||  decode(sd.Machinebooking||':'||sd.Cancellation,'1:1',1,'0:0',1,-1, 0) --valid_trans_val_1--trans
----------
From SalesDetail             sd
    ,SalesDetail             sub
...
AND    sd.CreaDate           >=  To_Date('2012-05-01-03-00-03', 'YYYY-MM-DD-HH24:MI:SS')       
AND    sd.CreaDate           <=  To_Date('2012-06-01-02-59-59', 'YYYY-MM-DD-HH24:MI:SS') 
AND    sd.PartitioningDate   >=  To_Date('2012-05-01-03-00-00', 'YYYY-MM-DD-HH24:MI:SS')   
AND    sd.PartitioningDate   <=  To_Date('2012-07-01-02-59-59', 'YYYY-MM-DD-HH24:MI:SS')      
/*   
AND mcm.TimeStamp >= To_Date('2010-09-20-03-00-00', 'YYYY-MM-DD-HH24:MI:SS') 
AND mcm.TimeStamp <= To_Date('2010-09-26-02-59-59', 'YYYY-MM-DD-HH24:MI:SS') 
AND mcm.PartitioningDate >= To_Date('2010-09-20-03-00-00', 'YYYY-MM-DD-HH24:MI:SS') 
AND mcm.PartitioningDate < To_Date('2009-11-03-03-00-00', 'YYYY-MM-DD-HH24:MI:SS') 
...
AND st.PartitioningDate >= To_Date('2009-10-18-03-00-00', 'YYYY-MM-DD-HH24:MI:SS') 
AND st.PartitioningDate < To_Date('2009-11-03-03-00-00', 'YYYY-MM-DD-HH24:MI:SS') 
*/ 
...
*/
spool \\mbta\park_plaza\itd\common\DBA\Oracle\data\report_outputs\usage_by_device_05-01-2012_to_05-31-2012.csv
/
