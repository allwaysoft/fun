...
--   
AND mcm.TimeStamp >= To_Date('2012-05-01-03-00-00', 'YYYY-MM-DD-HH24:MI:SS') 
AND mcm.TimeStamp <= To_Date('2012-06-01-02-59-59', 'YYYY-MM-DD-HH24:MI:SS') 
AND mcm.PartitioningDate >= To_Date('2012-05-20-03-00-00', 'YYYY-MM-DD-HH24:MI:SS') 
AND mcm.PartitioningDate < To_Date('2012-07-01-02-59-59', 'YYYY-MM-DD-HH24:MI:SS') 
...
AND st.PartitioningDate >= To_Date('2012-05-01-03-00-00', 'YYYY-MM-DD-HH24:MI:SS') 
AND st.PartitioningDate < To_Date('2012-07-01-02-59-59', 'YYYY-MM-DD-HH24:MI:SS') 
-- 
...
AND mcm.DeviceClassID in (501,411,441,901,801,802, 902, 442); -- device 442 added later, Rob Creedon
spool c:\usage_by_device1_05-01-2012_to_06-01-2012.csv
/
spool off