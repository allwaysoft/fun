...
CREATE TABLESPACE EMSDATA1
	DATAFILE 
	SIZE 100M AUTOEXTEND ON NEXT 10M MAXSIZE UNLIMITED
	EXTENT MANAGEMENT LOCAL AUTOALLOCATE SEGMENT SPACE MANAGEMENT AUTO;	

CREATE TABLESPACE EMSDATA2
	DATAFILE
	SIZE 3000M AUTOEXTEND ON NEXT 100M MAXSIZE UNLIMITED
	EXTENT MANAGEMENT LOCAL AUTOALLOCATE SEGMENT SPACE MANAGEMENT AUTO;

CREATE TABLESPACE EMSDATA3
	DATAFILE
	SIZE 2000M AUTOEXTEND ON NEXT 100M MAXSIZE UNLIMITED
	EXTENT MANAGEMENT LOCAL AUTOALLOCATE SEGMENT SPACE MANAGEMENT AUTO;

CREATE TABLESPACE EMSDATA4
	DATAFILE
	SIZE 6500M AUTOEXTEND ON NEXT 100M MAXSIZE UNLIMITED
	EXTENT MANAGEMENT LOCAL AUTOALLOCATE SEGMENT SPACE MANAGEMENT AUTO;

CREATE TABLESPACE EMSINDX1
	DATAFILE
	SIZE 100M AUTOEXTEND ON NEXT 10M MAXSIZE UNLIMITED
	EXTENT MANAGEMENT LOCAL AUTOALLOCATE SEGMENT SPACE MANAGEMENT AUTO;

CREATE TABLESPACE EMSINDX2
	DATAFILE
	SIZE 3500M AUTOEXTEND ON NEXT 100M MAXSIZE UNLIMITED 
	EXTENT MANAGEMENT LOCAL AUTOALLOCATE SEGMENT SPACE MANAGEMENT AUTO;

CREATE TABLESPACE EMSINDX3
	DATAFILE
	SIZE 2500M AUTOEXTEND ON NEXT 100M MAXSIZE UNLIMITED 
	EXTENT MANAGEMENT LOCAL AUTOALLOCATE SEGMENT SPACE MANAGEMENT AUTO;

CREATE TABLESPACE EMSINDX4
	DATAFILE
	SIZE 4500M AUTOEXTEND ON NEXT 100M MAXSIZE UNLIMITED 
	EXTENT MANAGEMENT LOCAL AUTOALLOCATE SEGMENT SPACE MANAGEMENT AUTO;

CREATE TABLESPACE EMSRPTS
	DATAFILE
	SIZE 50M AUTOEXTEND ON NEXT 5M MAXSIZE UNLIMITED
	EXTENT MANAGEMENT LOCAL AUTOALLOCATE SEGMENT SPACE MANAGEMENT AUTO;

CREATE TABLESPACE EMSUSER
	DATAFILE
	SIZE 7000M AUTOEXTEND ON NEXT 100M MAXSIZE UNLIMITED
	EXTENT MANAGEMENT LOCAL AUTOALLOCATE SEGMENT SPACE MANAGEMENT AUTO;

CREATE TABLESPACE MBTA_DATAWAREHOUSE1
	DATAFILE
	SIZE 100M AUTOEXTEND ON NEXT 10M MAXSIZE UNLIMITED
	EXTENT MANAGEMENT LOCAL AUTOALLOCATE SEGMENT SPACE MANAGEMENT AUTO;

CREATE TEMPORARY TABLESPACE EMSTEMP1 
	TEMPFILE
	SIZE 200M AUTOEXTEND ON NEXT 640K MAXSIZE UNLIMITED 
	TABLESPACE GROUP '' EXTENT MANAGEMENT LOCAL UNIFORM SIZE 50M;

create undo tablespace EMSUNDOTBS1 
	datafile size 100M  AUTOEXTEND ON  NEXT 10M MAXSIZE 5G;

alter system set UNDO_TABLESPACE=EMSUNDOTBS1 scope =both;
