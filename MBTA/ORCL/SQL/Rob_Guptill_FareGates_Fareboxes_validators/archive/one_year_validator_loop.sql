...
AND sd.creadate <=date2                                        --To_Date('2010-02-01-02-59-59', 'YYYY-MM-DD-HH24:MI:SS')
AND sd.PartitioningDate >= date1                            --To_Date('2010-09-01-03-00-00', 'YYYY-MM-DD-HH24:MI:SS')
AND sd.PartitioningDate <   date3                           --To_Date('2010-03-01-00-00-00', 'YYYY-MM-DD-HH24:MI:SS')
