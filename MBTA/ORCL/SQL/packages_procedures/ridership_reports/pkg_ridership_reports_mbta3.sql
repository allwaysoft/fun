...
--
  ...
  AND    hol.service_day (+) = decode(to_Char(sd.Creadate,''HH24''),''00'',decode(to_char(sd.creadate,''ddd'')-1,0,to_char(trunc(sd.creadate,''yyyy'')-1,''ddd'') ,to_char(sd.creadate,''ddd'')-1)
                                                     ,''01'',decode(to_char(sd.creadate,''ddd'')-1,0,to_char(trunc(sd.creadate,''yyyy'')-1,''ddd'') ,to_char(sd.creadate,''ddd'')-1)
                                                     ,''02'',decode(to_char(sd.creadate,''ddd'')-1,0,to_char(trunc(sd.creadate,''yyyy'')-1,''ddd'') ,to_char(sd.creadate,''ddd'')-1)
                                                            ,to_char(sd.creadate,''ddd''))
  AND    hol.service_year (+)  = decode(to_Char(sd.Creadate,''HH24''),''00'',decode(to_char(sd.creadate,''ddd'')-1,0,to_char(sd.creadate, ''yyyy'')-1 ,to_char(sd.creadate, ''yyyy''))
                                                     ,''01'',decode(to_char(sd.creadate,''ddd'')-1,0,to_char(sd.creadate, ''yyyy'')-1 ,to_char(sd.creadate, ''yyyy''))
                                                     ,''02'',decode(to_char(sd.creadate,''ddd'')-1,0,to_char(sd.creadate, ''yyyy'')-1,to_char(sd.creadate, ''yyyy''))
                                                            ,to_char(sd.creadate, ''yyyy''))
--
--	Filter conditions
--
	AND	mcm.MovementType	IN	 (7,20)
