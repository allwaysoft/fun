...
CREATE OR REPLACE DIRECTORY HRDEV_DATA_PUMP_DIR as '+HRDEVFRA/HRDEV/DUMPSET'
/
...
CREATE OR REPLACE DIRECTORY HRDMO_DATA_PUMP_LOG_DIR as '/u01/app/oracle/admin/hrdmo/dpdump'    -- Log files can't be written to ASM to put them at this location. Based on DB instance, change loc
/
GRANT READ, WRITE ON DIRECTORY HRDMO_DATA_PUMP_LOG_DIR TO DBADMIN;
/
