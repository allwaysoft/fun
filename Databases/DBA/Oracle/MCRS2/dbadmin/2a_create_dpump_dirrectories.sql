...
CREATE OR REPLACE DIRECTORY FAPA_DATA_PUMP_DIR as '+FAPAFRA'
/
...
CREATE OR REPLACE DIRECTORY FAPA_DATA_PUMP_LOG_DIR as '/u01/app/oracle/admin/fapa/dpdump'    -- Log files can't be written to ASM to put them at this location. Based on DB instance, change loc
/
GRANT READ, WRITE ON DIRECTORY FAPA_DATA_PUMP_LOG_DIR TO DBADMIN;
/
